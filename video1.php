	...
	<div class="row">	
			<div class="span2">			     
										<ul class="nav nav-tabs nav-stacked">
											<li>
											<a href="#add_user" data-toggle="modal" ><i class="icon-plus icon-large"></i>&nbsp;<strong>Add video</strong></a>
											</li>
										</ul>
										
										 
     <!-- Modal add user -->
	<?php include('modal_add_video.php'); ?>
			...
			<div class="span10">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Video Table</strong>
                                </div>
...
mysql_select_db("lemreservation", $lem);
								   ...
								   $user_query=mysql_query("select * from video")or die(mysql_error());
                                    ...
                                    <td width="100">
                                    	...
                                    	<?php include('modal_edit_video.php'); ?>
									</td>
