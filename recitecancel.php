...
$ticket=$_POST['ticket'];
	...
	while($row = $result->fetch(PDO::FETCH_ASSOC)){	
		 ...
		 echo $Time = $row['Time'];
		 echo $date = $row['date'];
		 echo $ticket_status = $row['ticket_status'];
  ...
  if($pay_way == "recite") {
	if($payment == "paid") {
		...
		mysql_query("INSERT INTO cancel (ID,Ticket_Number,username,Title,price,Time,date,penality,ticket_status) VALUES('','$ticket','$username','$Title','$price','$date','$Time','$total','$ticket_status')")or die(mysql_error());;
