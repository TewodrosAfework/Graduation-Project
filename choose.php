...
<p style="font-family: Berlin Sans FB Demi; font-weight:bolder;font-size: 30px; text-shadow: rgb(255, 0, 0) 6px 5px 5px; text-align: center; color: black;">Choose Your Payment
</p>
        ...
        ?>
          <ul class="moviess">
            ...
            <li>
              ...
              <div class="wrapper"><a href="indexs.php?id=<?php echo $id; ?>&date=<?php echo  $date; ?>&time=<?php echo $time; ?>" class="link2"><span><span>Recite</span></span></a></div>
            </li>
            <li class="last">
              
              <div class="wrapper"><a href="indexss.php?id=<?php echo $id; ?>&date=<?php echo  $date; ?>&time=<?php echo $time; ?>" class="link2"><span><span>Card</span></span></a></div>
            </li>
            <li class="clear">&nbsp;</li>
          </ul>
