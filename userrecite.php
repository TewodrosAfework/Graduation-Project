...
<body bgcolor="white">
<h2 Align="left" font face="Courier New", Courier, monospace" Color="Green">&nbsp;&nbsp;LEM Online Cinema Seat Reservation</br></br>&nbsp;&nbsp;&nbsp;COSTUMER'S COPY</font></h2>
...
$query=mysql_query("SELECT * FROM `ticket` ORDER BY `ticket`.`ID`  DESC");
{
...
<h1 align="left"><font face="arial" Color="black" size="2px">&nbsp;&nbsp;This is your copy. Keep this part in a sale place. The following are requirements when claiming your ticket:&nbsp;&nbsp;</br></font><font size="1">&nbsp;&nbsp;*&nbsp;This Ticket Voucher (Costumer's copy)<br>&nbsp;&nbsp;*&nbsp;Personally claim your movie ticket after reservation on working. Working days are from Monday to Sunday.<br>&nbsp;&nbsp;This document is valid after reservation until <?php echo $row['date']; ?>&nbsp;and&nbsp;<?php
include('conn.php');
$query=mysql_query("SELECT * FROM `ticket` ORDER BY `ticket`.`ID`  DESC");
{
	$row=mysql_fetch_array($query);
