	...
	<form class="form-horizontal" method="post">
			<div class="control-group">
				...
				<div class="control-group">
				<label class="control-label" for="inputEmail">Seat</label>
				<div class="controls">

				<input readonly type="text" id="inputEmail" name="username" value="<?php echo $row['seat']; ?>" required>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
				<input readonly type="text" id="inputEmail" name="email" value="<?php echo $row['payment']; ?>" required>
				</div>
			</div>
	...
	mysql_query("update ticket set ticket_status='$status' where ID='$user_id'")or die(mysql_error()); ?>
	<script>
	window.location="ticketcontroller.php";
	</script>
	<?php
	}
	?>