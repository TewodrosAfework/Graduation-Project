...
<p style="margin-left:220px; margin-top:-45px;"><input name="newpass" type="password" required="required"></p>
...
<p style="margin-left:220px; margin-top:-45px;"><input name="repass" type="password" required="required"></p>
