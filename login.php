...
<body>
	...
	<div id="body" class="movies">
	   <p style="font-family: Berlin Sans FB Demi; font-weight:bolder;font-size: 30px; text-shadow: rgb(255, 0, 0) 6px 5px 5px; text-align: center; color: white;">Make Reservation</p>
	  
	  <div id="recovery">
	  <form action="check.php" method="post">
  <p style="margin-left:10px; margin-top:30px; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 20px; color: white; font-weight:bolder">Email:</p>
  <p style="margin-left:150px;  margin-top:-20px;"> <input name="email" type="text" size="30" required="required" >&nbsp;</p>

  <p style="margin-left:10px; margin-top:10px; font-family: Berlin Sans FB Demi; text-shadow: rgb(255, 0, 0) 6px 5px 5px; font-size: 20px; color: white; font-weight:bolder">Password:</p>
  <p style="margin-left:150px;  margin-top:-20px;"> <input name="pass" id="passid" type="password" size="30" required="required"/><br>
  <br /><br />
  <p style="margin-left:100px; margin-top:-25px;"><input name="submits" value="Login Account" type="submit">
  </p>
  </form>
	</div>
